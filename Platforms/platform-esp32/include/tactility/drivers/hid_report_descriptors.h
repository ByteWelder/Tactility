...
/** Gamepad only (report ID 1, 9 bytes: axes X/Y/Z/Rx/Ry/Rz (1 byte each), hat/dpad (1 byte,
 *  1-8 = 8-direction clockwise from Up, 0 = centered/released), buttons[12] (2 bytes, 4
