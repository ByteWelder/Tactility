...
#define HARDWARE_WIDTH CYD_2432S022C_LCD_VERTICAL_RESOLUTION
#define HARDWARE_HEIGHT CYD_2432S022C_LCD_HORIZONTAL_RESOLUTION

// Buffer height for partial rendering (fixed)
#define BUFFER_HEIGHT CYD_2432S022C_LCD_DRAW_BUFFER_HEIGHT
