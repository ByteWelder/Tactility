...
void YellowDisplay::initialize() {
    ...
    uint32_t stride = CYD_2432S022C_LCD_HORIZONTAL_RESOLUTION * sizeof(lv_color_t);  // Calculate stride
    lv_draw_buf_t* draw_buf = lv_draw_buf_create(CYD_2432S022C_LCD_HORIZONTAL_RESOLUTION,
