...
#define CROWPANEL_LCD_PIN_BACKLIGHT GPIO_NUM_38
#define CROWPANEL_LCD_SPI_FREQUENCY 80000000
...
#define CROWPANEL_LCD_DRAW_BUFFER_HEIGHT (CROWPANEL_LCD_VERTICAL_RESOLUTION / 10)
