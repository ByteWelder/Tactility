...
static bool initBacklight() {
    ...
    ledc_timer_config_t ledc_timer = {
        .speed_mode = CROWPANEL_LCD_BACKLIGHT_LEDC_MODE,
        .duty_resolution = CROWPANEL_LCD_BACKLIGHT_LEDC_DUTY_RES,
        .timer_num = CROWPANEL_LCD_BACKLIGHT_LEDC_TIMER,
        .freq_hz = CROWPANEL_LCD_BACKLIGHT_LEDC_FREQUENCY,
...
static bool setBacklight(uint8_t duty) {
    ledc_channel_config_t ledc_channel = {
        .gpio_num = CROWPANEL_LCD_PIN_BACKLIGHT,
        .speed_mode = CROWPANEL_LCD_BACKLIGHT_LEDC_MODE,
        .channel = CROWPANEL_LCD_BACKLIGHT_LEDC_CHANNEL,
        .intr_type = LEDC_INTR_DISABLE,
        .timer_sel = CROWPANEL_LCD_BACKLIGHT_LEDC_TIMER,
        .duty = duty,
        .hpoint = 0,
...
bool CrowPanelDisplay::start() {
    TT_LOG_I(TAG, "Starting");

    const esp_lcd_panel_io_spi_config_t panel_io_config = {
        .cs_gpio_num = CROWPANEL_LCD_PIN_CS,
        .dc_gpio_num = CROWPANEL_LCD_PIN_DC,
        .spi_mode = 0,
        .pclk_hz = CROWPANEL_LCD_SPI_FREQUENCY,
    ...
    if (esp_lcd_new_panel_io_spi((esp_lcd_spi_bus_handle_t)CROWPANEL_LCD_SPI_HOST, &panel_io_config, &ioHandle) != ESP_OK) {
    ...
    const esp_lcd_panel_dev_config_t panel_config = {
        ...
        .bits_per_pixel = CROWPANEL_LCD_BITS_PER_PIXEL,
        .flags = {
            .reset_active_high = 0
        },
    ...
    const lvgl_port_display_cfg_t disp_cfg = {
        ...
        .buffer_size = CROWPANEL_LCD_HORIZONTAL_RESOLUTION * CROWPANEL_LCD_DRAW_BUFFER_HEIGHT,
        .double_buffer = false, // Disable to free up memory
        .trans_size = 0,
        .hres = CROWPANEL_LCD_HORIZONTAL_RESOLUTION,
        .vres = CROWPANEL_LCD_VERTICAL_RESOLUTION,
        .monochrome = false,
        .rotation = {
            .swap_xy = true,
            .mirror_x = true,
...
void CrowPanelDisplay::setPowerOn(bool turnOn) {
...
void CrowPanelDisplay::setGammaCurve(uint8_t index) {
    uint8_t gamma_curve;
    switch (index) {
        case 0:
            gamma_curve = 0x01;
...
std::shared_ptr<tt::hal::display::DisplayDevice> createDisplay() {
    return std::make_shared<CrowPanelDisplay>();
}
